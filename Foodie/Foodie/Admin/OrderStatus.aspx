                                ...
                                <div class="card-block">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-8">
                                            ...
                                            <div class="card-block table-border-style">
                                             <div class="table-responsive">
                                                 <asp:Repeater runat="server" Id="rOrderStatus" OnItemCommand="rOrderStatus_ItemCommand" OnItemDataBound="rOrderStatus_ItemDataBound">
                                                     <HeaderTemplate>
                                                     ...
                                                     <ItemTemplate>
                                                         <tr>
                                                              ...
                                                              <td class="table-plus"><%# Eval("OrdderDate") %></td>
                                                              <td>
                                                              ...
                                                              <td><%# Eval("PaymentMode") %></td>
                                                                 <td>
                                                                     <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandName="edit" CssClass="badge bg-primary" 
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4 mobile-inputs">
                                            <asp:Panel ID="pUpdateOrderStatus" runat="server"> <h4 class="sub-title">Update Status</h4>
                                         <div>
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Order status is required" ForeColor="Red" 
                                                        ControlToValidate="ddlOrderStatus" SetFocusOnError="true" Display="Dynamic" InitialValue="0"></asp:RequiredFieldValidator>
                                            ...
                                            &nbsp;
                                            <asp:Button runat="server" Text="Cancel" Id="btnCancel" CssClass="btn btn-primary"  OnClick="btnCancel_Click"/>
                                        </div>
